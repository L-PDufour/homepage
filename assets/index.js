...
var ASM_CONSTS = {
  105232: () => { if (document.fullscreenElement) return 1; },  
 105278: () => { return document.getElementById('canvas').width; },  
 105330: () => { return parseInt(document.getElementById('canvas').style.width); },  
 105398: () => { document.exitFullscreen(); },  
 105425: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 105498: () => { if (document.fullscreenElement) return 1; },  
 105544: () => { return document.getElementById('canvas').width; },  
 105596: () => { return screen.width; },  
 105621: () => { document.exitFullscreen(); },  
 105648: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 105781: () => { return window.innerWidth; },  
 105807: () => { return window.innerHeight; },  
 105834: () => { if (document.fullscreenElement) return 1; },  
 105880: () => { return document.getElementById('canvas').width; },  
 105932: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106000: () => { if (document.fullscreenElement) return 1; },  
 106046: () => { return document.getElementById('canvas').width; },  
 106098: () => { return screen.width; },  
 106123: () => { return window.innerWidth; },  
 106149: () => { return window.innerHeight; },  
 106176: () => { if (document.fullscreenElement) return 1; },  
 106222: () => { return document.getElementById('canvas').width; },  
 106274: () => { return screen.width; },  
 106299: () => { document.exitFullscreen(); },  
 106326: () => { if (document.fullscreenElement) return 1; },  
 106372: () => { return document.getElementById('canvas').width; },  
 106424: () => { return parseInt(document.getElementById('canvas').style.width); },  
 106492: () => { document.exitFullscreen(); },  
 106519: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 106577: () => { return screen.width; },  
 106602: () => { return screen.height; },  
 106628: () => { return window.screenX; },  
 106655: () => { return window.screenY; },  
 106682: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 106735: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 106806: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 106863: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 107119: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 107190: () => { if (document.fullscreenElement) return 1; },  
 107236: () => { return window.innerWidth; },  
 107262: () => { return window.innerHeight; },  
 107289: () => { if (document.pointerLockElement) return 1; }
};
...
var ___emscripten_embedded_file_data = Module['___emscripten_embedded_file_data'] = 98972;
